...
import com.truist.batch.service.ManualJobConfigService.ConfigurationStatistics;
...
class ManualJobConfigServiceTest {
    ...
    class CreateJobConfigurationTests {
        ...
        void shouldGenerateUniqueConfigurationId() {
            ...
            assertThat(savedEntity.getConfigId()).hasSizeGreaterThan(25); // Variable length format
        }
