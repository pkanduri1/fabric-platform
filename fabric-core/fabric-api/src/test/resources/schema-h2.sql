...
-- MANUAL_JOB_CONFIG table (for Job Execution API integration tests)
CREATE TABLE IF NOT EXISTS MANUAL_JOB_CONFIG (
    CONFIG_ID VARCHAR(50) PRIMARY KEY,
    JOB_NAME VARCHAR(200),
    JOB_TYPE VARCHAR(50),
    SOURCE_SYSTEM VARCHAR(50),
    TARGET_SYSTEM VARCHAR(50),
    MASTER_QUERY_ID VARCHAR(50),
    BATCH_CONFIG_ID VARCHAR(50),
    JOB_PARAMETERS CLOB,
    ...
    VERSION_DECIMAL BIGINT DEFAULT 1
);

-- MANUAL_JOB_EXECUTION table (for Job Execution API integration tests)
CREATE TABLE IF NOT EXISTS MANUAL_JOB_EXECUTION (
    ...
    CORRELATION_ID VARCHAR(100),
    MONITORING_ALERTS_SENT CHAR(1) DEFAULT 'N',
    EXECUTED_BY VARCHAR(100),
    EXECUTION_HOST VARCHAR(100),
    EXECUTION_ENVIRONMENT VARCHAR(50),
    CREATED_DATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CALLBACK_URL VARCHAR(2000),
    CALLBACK_HEADERS CLOB,
    CALLBACK_STATUS VARCHAR(20) DEFAULT 'SKIPPED',
    API_SOURCE VARCHAR(10) DEFAULT 'UI'
);
