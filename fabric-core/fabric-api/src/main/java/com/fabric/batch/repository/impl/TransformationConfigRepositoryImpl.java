 ...
 *   <li>us051-001 addition: ID (standalone surrogate key, VARCHAR2(100))</li>
 * </ul>
 * The FIELD_TEMPLATES table uses a composite natural PK
 * (FILE_TYPE, TRANSACTION_TYPE, FIELD_NAME) plus a standalone ID column
 * added by changeset us051-001. The ID is generated by the Java layer
 * (UUID without hyphens) on insert.
 */
@Repository
...
public class TransformationConfigRepositoryImpl implements TransformationConfigRepository {
    ...
    /**
     * Looks up a field template by its standalone ID column (added by us051-001).
    ...
    public FieldTemplateEntity save(FieldTemplateEntity entity) {
        ...
        // Generate a surrogate ID if the caller did not supply one
        ...
        log.debug("save: id={}, fileType={}, txnType={}, fieldName={}",
    ...
    private static class FieldTemplateRowMapper implements RowMapper<FieldTemplateEntity> {
        ...
        public FieldTemplateEntity mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            // ID column added by changeset us051-001
