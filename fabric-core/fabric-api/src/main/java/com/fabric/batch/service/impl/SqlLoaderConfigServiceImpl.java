...
public class SqlLoaderConfigServiceImpl implements SqlLoaderConfigService {
    ...
    public SqlLoaderConfigResponse createConfiguration(@Valid @NotNull SqlLoaderConfigRequest request) {
        ...
        try {
            ...
            var savedConfig = (com.fabric.batch.entity.SqlLoaderConfigEntity) savedConfigObj;
    ...
    public SqlLoaderConfigResponse updateConfiguration(@NotBlank String configId, @Valid @NotNull SqlLoaderConfigRequest request) {
        ...
        try {
            ...
            var updatedConfig = (com.fabric.batch.entity.SqlLoaderConfigEntity) updatedConfigObj;
    ...
    public Optional<SqlLoaderConfigResponse> getConfiguration(@NotBlank String configId) {
        ...
        try {
            ...
            var configEntity = (com.fabric.batch.entity.SqlLoaderConfigEntity) configEntityObj;
    ...
    public Optional<SqlLoaderConfigResponse> getConfigurationBySourceAndJob(@NotBlank String sourceSystem, @NotBlank String jobName) {
        ...
        try {
            ...
            if (configEntity.isPresent()) {
                var configEntityCasted = (com.fabric.batch.entity.SqlLoaderConfigEntity) configEntity.get();
    ...
    private com.fabric.batch.entity.SqlLoaderConfigEntity convertRequestToEntity(SqlLoaderConfigRequest request) {
        // This is a simplified conversion - real implementation would use proper mapping
        return com.fabric.batch.entity.SqlLoaderConfigEntity.builder()
                .jobName(request.getJobName())
                .sourceSystem(request.getSourceSystem())
                .targetTable(request.getTargetTable())
                .loadMethod(com.fabric.batch.entity.SqlLoaderConfigEntity.LoadMethod.valueOf(request.getLoadMethod()))
    ...
    private List<com.fabric.batch.entity.SqlLoaderFieldConfigEntity> convertFieldRequestsToEntities(List<FieldConfigRequest> fieldRequests) {
    ...
    private com.fabric.batch.entity.SqlLoaderFieldConfigEntity convertFieldRequestToEntity(FieldConfigRequest request) {
        // Simplified conversion
        return com.fabric.batch.entity.SqlLoaderFieldConfigEntity.builder()
                ...
                .dataType(com.fabric.batch.entity.SqlLoaderFieldConfigEntity.DataType.valueOf(request.getDataType()))
    ...
    private SqlLoaderConfigResponse convertEntityToResponse(com.fabric.batch.entity.SqlLoaderConfigEntity entity) {
        // Simplified conversion
    ...
    private void generateInitialControlFileTemplate(com.fabric.batch.entity.SqlLoaderConfigEntity config) {
    ...
    private void updateControlFileTemplate(com.fabric.batch.entity.SqlLoaderConfigEntity config) {
