...
import com.fabric.batch.model.TemplateMetadata;
import com.fabric.batch.model.TemplateToConfigurationResult;
...
public class TemplateController {
    ...
    public ResponseEntity<Map<String, Object>> saveTemplateConfiguration(
            @RequestBody com.fabric.batch.model.TemplateConfigDto config) {
        try {
