...
import com.fabric.batch.entity.SqlLoaderFieldConfigEntity;
import com.fabric.batch.entity.SqlLoaderSecurityAuditEntity;
import com.fabric.batch.repository.SqlLoaderConfigRepository;
import com.fabric.batch.repository.SqlLoaderFieldConfigRepository;
import com.fabric.batch.repository.SqlLoaderSecurityAuditRepository;
import com.fabric.batch.sqlloader.SqlLoaderConfig;
...
public class SqlLoaderConfigurationManagementService {
    ...
    public SqlLoaderConfig convertToExecutionConfig(@NotBlank String configId) {
        ...
        return SqlLoaderConfig.builder()
                ...
                .bindSize(config.getBindSize().intValue())
                .readSize(config.getReadSize().intValue())
                ...
                .resumableTimeout(String.valueOf(config.getResumableTimeout()))
                .resumableName(config.getResumableName())
                .streamSize(String.valueOf(config.getStreamSize()))
