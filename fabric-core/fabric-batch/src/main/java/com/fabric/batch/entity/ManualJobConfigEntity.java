...
/**
 * POJO for Manual Job Configuration in fabric-batch module.
 * 
 * This entity represents job configuration data for batch processing operations.
 * It is specifically designed for the fabric-batch module to avoid dependencies 
 * on the fabric-api module.
 * 
...
public class ManualJobConfigEntity {
    ...
    /**
     * Master Query ID for linking to query configurations.
     * Used for database-driven batch jobs.
     */
